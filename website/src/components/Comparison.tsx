...
const rows: { feature: string; forge: boolean | string; cloud: boolean | string }[] = [
  { feature: "Inference can run offline after local model/runtime setup", forge: true, cloud: false },
  ...
  { feature: "Local voice + selected screen crop with a visual-only cursor cue (no hosted fallback)", forge: true, cloud: false },
